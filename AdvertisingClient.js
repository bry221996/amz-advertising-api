...
module.exports = class AdvertisingClient {
  ...
  register() {
    return this.apiRequest(
      `profiles/register`,
      { countryCode: this.options.region },
      "PUT"
    );
  }
  listPortfolios(data) {
  ...
  getPortfolio(portfolioId) {
    return this.apiRequest(`v2/portfolios/${portfolioId}`, null, "GET");
  }
  getPortfolioEx(portfolioId) {
    return this.apiRequest(
  ...
  getCampaign(campaignType, campaignId, version = "", isExtended = false) {
